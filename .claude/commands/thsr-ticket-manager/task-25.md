# thsr-ticket-manager - Task 25

Execute task 25 for the thsr-ticket-manager specification.
...
## Usage
```
/Task:25-thsr-ticket-manager
```

## Instructions

Execute with @spec-task-executor agent the following task: "建立 Header 元件 🔄"

```
Use the @spec-task-executor agent to implement task 25: "建立 Header 元件 🔄" for the thsr-ticket-manager specification and include all the below context.
...
## Task Details
- Task ID: 25
- Description: 建立 Header 元件 🔄
- Requirements: NFR-Usability

## Instructions
- Implement ONLY task 25: "建立 Header 元件 🔄"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks thsr-ticket-manager 25 --mode complete
...
```bash
claude-code-spec-workflow get-tasks thsr-ticket-manager 25 --mode complete
```
