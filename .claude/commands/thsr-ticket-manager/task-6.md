# thsr-ticket-manager - Task 6

Execute task 6 for the thsr-ticket-manager specification.
...
## Usage
```
/Task:6-thsr-ticket-manager
```

## Instructions

Execute with @spec-task-executor agent the following task: "建立圖片處理工具 🔄"

```
Use the @spec-task-executor agent to implement task 6: "建立圖片處理工具 🔄" for the thsr-ticket-manager specification and include all the below context.
...
## Task Details
- Task ID: 6
- Description: 建立圖片處理工具 🔄
- Requirements: 1.1, 1.6

## Instructions
- Implement ONLY task 6: "建立圖片處理工具 🔄"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks thsr-ticket-manager 6 --mode complete
...
```bash
claude-code-spec-workflow get-tasks thsr-ticket-manager 6 --mode complete
```
