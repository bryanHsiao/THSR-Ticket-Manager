# thsr-ticket-manager - Task 15

Execute task 15 for the thsr-ticket-manager specification.
...
## Usage
```
/Task:15-thsr-ticket-manager
```

## Instructions

Execute with @spec-task-executor agent the following task: "設定 Google OAuth 憑證 ⏳"

```
Use the @spec-task-executor agent to implement task 15: "設定 Google OAuth 憑證 ⏳" for the thsr-ticket-manager specification and include all the below context.
...
## Instructions
- Implement ONLY task 15: "設定 Google OAuth 憑證 ⏳"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks thsr-ticket-manager 15 --mode complete
...
```bash
claude-code-spec-workflow get-tasks thsr-ticket-manager 15 --mode complete
```
