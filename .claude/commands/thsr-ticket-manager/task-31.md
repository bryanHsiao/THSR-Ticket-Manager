# thsr-ticket-manager - Task 31

Execute task 31 for the thsr-ticket-manager specification.
...
## Usage
```
/Task:31-thsr-ticket-manager
```

## Instructions

Execute with @spec-task-executor agent the following task: "建立 TicketCard 元件 🔄"

```
Use the @spec-task-executor agent to implement task 31: "建立 TicketCard 元件 🔄" for the thsr-ticket-manager specification and include all the below context.
...
## Task Details
- Task ID: 31
- Description: 建立 TicketCard 元件 🔄
- Leverage: src/types/ticket.ts
- Requirements: 2.3, 2.5, 2.6

## Instructions
- Implement ONLY task 31: "建立 TicketCard 元件 🔄"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks thsr-ticket-manager 31 --mode complete
...
```bash
claude-code-spec-workflow get-tasks thsr-ticket-manager 31 --mode complete
```
